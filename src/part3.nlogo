globals [ max-sheepW max-sheepB range-move sheepWNumber sheepBNumber ]
...
to checkPopulationSheepW
  ...
  [set weightGainSheep weightGainSheep]
  [set weightGainSheep weightGainSheep - weightGainSheep]
